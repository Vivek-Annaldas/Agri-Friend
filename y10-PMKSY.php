...
<body>
     ...
     <?php @include("head1.php");?>
      ...
      <div class="carousel-item active">
        <img src="images/_Pradhan-Mantri-Krishi-Sinchayee-Yojana.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading">Pradhan Mantri Krishi Sinchayee Yojana</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col">
            ...
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">OOn July 1, 2015, the Pradhan Mantri Krishi Sinchayee Yojana (Pradhan Mantri Krishi Sinchayee Yojana) was launched to expand cultivated area 
                with assured irrigation and reduce wastage of water in the country. The scheme focuses on creating sources-protective irrigation by harnessing 
                rainwater at a micro level through ‘Jal Sanchay’ and ‘Jal Sinchan’. Micro irrigation is also incentivised through subsidies to ensure 
                ‘Per Drop More Crop’.
              </p>   </div> <br/>
            </div>
          ...
          <div class="col">
            <img src="images/scheme10.jpg" class="img-thumbnail introimg img-thumbnail-1" alt="...">
          </div></div></div>
