...
<!-- header -->
    <header>
      ...
      <div class="carousel-item active">
        <img src="images/scheme1.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading">Atmanirbhar Bharat Abhiyaan</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col">
            ...
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">In May 2020, Prime Minister, Mr. Narendra Modi launched the Self-reliant India (Atmanirbhar Bharat Abhiyan)
                mission to promote Indian goods in the global supply chain markets and help the country achieve self-reliance. 
                The mission was announced amid the pandemic when the government allocated funds worth Rs. 20 lakh crore (US$ 268.74 billion), 
                which amounts to ~10% of India’s GDP, as a stimulus package to help recover the economy by promoting incentives for domestic production. 
                It encompasses themes such as ‘Local for Global: Make in India for the World’ and ‘Vocal for Local’.
                ...
                Determine adequacy of each sector (e.g., defence, agriculture, healthcare, infrastructure, etc.), with the help of FY22 budget,
                to achieve self-reliance.</p> </div><br/><br/><br/><br/>
            </div>
            
          </div>
          <div class="col">
            <img src="images/attam-nirbhar.jpg" class="img-thumbnail introimg img-thumbnail-1" alt="...">
          </div>
		  </div>
		  </div>
