...
<!-- header -->
    <header>
      ...
      <div class="carousel-item active">
        <img src="images/Bhartiya-Janaushadhi-Pariyojana.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading2">Pradhan Mantri Bhartiya Janaushadhi Pariyojana (PMBJP)</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col"><div class="schemebox">
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">In November 2008, the Department of Pharmaceuticals introduced the Pradhan Mantri Bhartiya Janaushadhi Pariyojana 
                (PMBJP) in India to provide quality medicines at affordable prices to the masses. The scheme was previously named as 
                ‘Jan Aushadhi’.
                ...
                Providing all the related healthcare products under the scheme.</p> </div><br/><br/><br/><br/>
            </div>
            
          </div>
          <div class="col">
            <img src="images/scheme3.jpg" class="img-thumbnail introimg img-thumbnail-1" alt="...">
          </div>
		   </div>
		    </div>
