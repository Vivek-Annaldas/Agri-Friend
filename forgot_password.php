  ...
  { 
   ...
   if($password1 != $password2)
    ...
    }else
    {
      ...
      $chngpwd1->execute();
      echo "<script>alert('Your Password succesfully changed Now You Can Login');</script>";
      }
      else {
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <img class="img-avatar mb-3" style="width:200px;" src="images/Agrifriend-1 (2)1 (2).png" alt=""><br>
                </div>
                ...
                <form class="js-validation-signin px-30" method="post" name="chngpwd" onSubmit="return valid();">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Login <a href="index1.php" class="text-primary">Click here</a>
                  </div>
                </form>
              </div>
            </div>
