...
<body>
     ...
     <?php @include("head1.php");?>
      ...
      <div class="carousel-item active">
        <img src="images/Garib-Kalyan-Yojana.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading">Garib Kalyan Yojana</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col">
            ...
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">In 2016, the Govt. of India launched Pradhan Mantri Garib Kalyan Yojana as a part of the Taxation Laws Act 2016
                 (second amendment). The initial objective of the PM garib kalyan yojana scheme was to ensure tax evaders declare
                  unaccounted money and avoid penalty and criminal prosecution. Through this scheme, the govt. intended to use the
                   deposited black money for welfare of the poor people. The scheme was valid from December 2016 to March 2017.

                In 2020, the govt. extended the scheme to include relief packages during the pandemic. The aim was to support
                 livelihood of poor during COVID-related lockdowns.</p></div><br/><br/><br/><br/>
            </div>
            
          </div>
          <div class="col">
            <img src="images/scheme5.jpg" class="img-thumbnail introimg img-thumbnail-1" alt="...">
          </div>
		  </div>
		  </div>
