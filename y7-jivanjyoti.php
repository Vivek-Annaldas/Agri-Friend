...
<?php @include("head1.php");?>
      ...
      <div class="carousel-item active">
        <img src="images/Jeevan-Jyoti-Bima-Yojana.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading1">Pradhan Mantri Jeevan Jyoti Bima Yojana</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col">
            ...
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">On May 09, 2015, the Government of India launched Pradhan Mantri Jeevan Jyoti Bima Yojana (PMJJBY)—a government-backed life insurance scheme in India.
                 It was originally proposed in the 2015 budget speech by the finance minister, as only 20% of India’s population was endorsed under any kind of insurance
                  until then. Consequently, the PMJJBY was launched to increase penetration of life insurance among citizens.
          ...
          <div class="col">
            <img src="images/scheme7.jpg" class="img-thumbnail introimg img-thumbnail-1" alt="...">
          </div>
		  </div></div>
