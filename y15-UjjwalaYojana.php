...
<?php @include("head1.php");?>
      <div class="carousel-item active">
        <img src="images/_Ujjwala-Yojana.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading">Pradhan Mantri Ujjwala Yojana</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col">
            ...
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">In 2016, the Indian government launched Pradhan Mantri Ujjwala Yojana (PMUY), a social welfare scheme supporting
                 Prime Minister Narendra Modi’s vision of smoke-free rural India. The scheme was introduced with the aim to provide 
                 concessional LPG connections to the whole country by 2019.

                The scheme was expected to benefit 80 million families (the previous target was 50 million families), especially
                those living below poverty line (BPL). It will help increase LPG usage and reduce air pollution, deforestation and
                 health disorders among citizens.
              </p></div><br/><br/><br/><br/><br/><br/><br/><br/>
            </div>
            
          </div>
          <div class="col">
            <img src="images/scheme15.jpg" class="img-thumbnail introimg img-thumbnail-1" alt="...">
          </div></div></div>
