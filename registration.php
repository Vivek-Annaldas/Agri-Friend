...
<head>
	<title>Registration</title>
	  ...
	  <link rel="stylesheet" type="text/css" href="css/rmstyle.css"/>
...
<body>
	...
	<div class="form_container registrationphp1">
	<center><h1  class="registrationphp">REGISTRATION FORM</h1></center>
	<br />
	<form action="registration.php" method="POST" enctype="multipart/form-data">
	<label>Enter Your Full Name:</label>
	<input type="text" class="input_box" name="full_name" placeholder="Enter Full Name" required/>



	<label>Enter Mobile Number</label>
	<input type="number" class="input_box" name="mobile_number" placeholder="Enter mobile number" required/>
	
	<br />
	
	<label>Enter DOB</label>
	<input type="date" class="input_box" name="dob" placeholder="Enter DOB" required/>
	
	<br />
	
	<label>Enter Time</label>
	<input type="time" class="input_box" name="time" placeholder="Enter Time" required/>
	
	<br />
	<label>Enter Address</label>
	<textarea name="address" class="input_box" placeholder="Enter address" required></textarea>
	...
	<select name="city" class="input_box">
		...
		<option value="Solapur">Solapur City</option>
		<option value="Pune">Pune</option>
		<option value="Pune">latur</option>
		<option value="Pune">sambhajinagar</option>
		<option value="Pune">raigad</option>
		<option value="Pune">mumbai</option>
		<option value="Pune">dharashiv</option>

	</select>
	<br />
	<label>profile photo</label>
	<input type="file" class="input_box" name="picture" />
	...
	<center><input type="submit" name="submit_btn" value="CREATE MY ACCOUNT" class="subbtncstm"/>   </center>     
	</div>
