            ...
            <div class="col-md-4 stretch-card grid-margin" >
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body" >
                  ...
                  <h4 class="font-weight-normal mb-3"style="color:white;">Registered Users
                  </h4>
                  <?php 
                  ...
                  ?>
                  <h2 class="mb-5" style="color:white;"><?php echo htmlentities($totalunreadquery);?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3" style="color:white;">Total Products 
                  </h4>
                  <?php
                  $sql=mysqli_query($con,"select id from tblproducts");
                  $listedproduct=mysqli_num_rows($sql);
                  ?>
                  <h2 class="mb-5" style="color:white;"><?php echo $listedproduct;?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3" style="color:white;">Total sales till date 
                  </h4>
                  <?php
                  ...
                  ?>
                  <h2 class="mb-5" style="color:white;"><?php echo number_format($row['total'],2);?></h2>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3" style="color:white;">Weekly Sales <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                  </h4>
                  <?php
                  ...
                  ?>
                  <h2 class="mb-5" style="color:white;"><?php echo number_format($row['week'],2);?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3" style="color:white;">Yesterday Total Sales
                  </h4>
                  <?php
                  ...
                  ?>
                  <h2 class="mb-5" style="color:white;"><?php echo number_format($rw['yesterday'],2);?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3" style="color:white;">Today's Total Sales 
                  </h4>
                  <?php
                  ...
                  ?>
                  <h2 class="mb-5" style="color:white;"><?php echo number_format($today['today'],2);?></h2>
                </div>
              </div>
            </div>
          </div>
