                                            ...
                                            {    
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=" text-center">
                                                        ...
                                                        <a href="userinfo.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Block ?');" title="Block this User"><i class="mdi mdi-delete fa-delete"style="color: #f05050"  aria-hidden="true"></i></a> </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1;
                                                }
                                            } ?>
