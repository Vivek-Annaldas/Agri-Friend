...
<body>
     ...
     <?php @include("head1.php");?>
      ...
      <div class="carousel-item active">
        <img src="images/Pradhan-Mantri-Awaas-Yojana.jpg" height="50%" width="100%" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="page-heading">Pradhan Mantri Awaas Yojana</h1>
        </div>
        ...
        <div class="row align-items-start">
          <div class="col">
            ...
            <h2 class="schemeintro">INTRODUCTION</h2>
              <p class="orgop1">In 2015, the Indian government introduced the Pradhan Mantri Awas Yojana (PMAY) to provide affordable housing to
                 all citizens by 2022. Through this credit linked subsidy scheme (CLSS), the government aimed to provide its 
                 beneficiaries an interest subsidy to avail loans to purchase or build a house. The scheme was launched to aid 
                 the middle-income community, economically weaker sections (EWS) and low-income groups (LIG). Depending on the 
                 areas it serves, the scheme is divided into two sections, Pradhan Mantri Awas Yojana-Urban (PMAY-U) and Pradhan 
                ...
                across the country over the next seven years (between 2015 and 2022).
                Launched in November 2016, PMAY-G was designed to support ‘Housing for All by 2022 by building 2.95 crore houses for 
                rural poor across the country by 2022.
              </p></div><br/><br/><br/><br/><br/>
            </div>
            
          </div>
          <div class="col">
            <img src="images/scheme11.jpg" class="img-thumbnail introimg imgs11 img-thumbnail-1" alt="...">
          </div></div></div>
