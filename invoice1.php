  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel" Style="width:100%; background-color:	#f2f2f2;">
        <div class="content-wrapper" Style="width:95%; margin-left: auto; background-color:	#f2f2f2;">
                    ...
                    <div class="invoice-from-wrap">
                      <div class="row">
                        <div class="col-md-7 mb-20">
                          <h3 class="mb-35 font-weight-600">Your Order Placed Successful</h3>
                          <h6 class="mb-5">Thank You Visit Again</h6>
                        </div>
                        <?php 
                        //Consumer Details
