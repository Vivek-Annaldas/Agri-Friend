...
if (!empty($current_quantity)&&$current_quantity>=$quantity1) {

    $rquantity = $current_quantity - $quantity1;
    if($rquantity<=0)
    {
      $rquantity=0;
    ...
    $query1 = mysqli_query($con, "UPDATE tblproducts SET quantity='$rquantity' WHERE id='$pid'");
}
...
//code for adding product in cart
    case "add":
      ...
      $v1="Vegetables";
      if(!empty($_POST["quantity"])&&$current_quantity>=$quantity1){
      $pid=$_GET["pid"];
...
if(isset($_POST['checkout'])){
  ...
  echo "<script>window.location.href='allproductinvoice.php'</script>";
                      ...
                      {    
                        ...
                        <form method="post" action="product1vegetable.php?action=add&pid=<?php echo $row["id"]; ?>">                                                  
                          <tr>
                            ...
                            <input type="hidden" id="cat" name="cat" value="<?php echo $Categry;?>">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="table-responsive p-3">
                  ...
                  ?>
                  <div style="color:red; margin-left:99px;" align="center">Your Cart is Empty</div>
                  <?php 
                }
                ?>
